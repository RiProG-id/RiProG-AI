...
write_file "/proc/sys/vm/dirty_ratio" "20"
...
write_file "/proc/sys/vm/stat_interval" "1103"
write_file "/proc/sys/vm/panic_on_oom" "0"
write_file "/proc/sys/vm/swappiness" "30"
write_file "/proc/sys/vm/vfs_cache_pressure" "60"
write_file "/proc/sys/vm/overcommit_ratio" "50"
write_file "/proc/sys/vm/extra_free_kbytes" "24300"
write_file "/proc/sys/kernel/random/read_wakeup_threshold" "128"
write_file "/proc/sys/kernel/random/write_wakeup_threshold" "256"
